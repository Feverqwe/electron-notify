...
function setContents(event, notificationObj) {
  ...
  // subtitle
  let subtitleDoc = notiDoc.getElementById('subtitle');
  if (notificationObj.subtitle) {
    subtitleDoc.innerHTML = notificationObj.subtitle;
  } else {
    setStyleOnDomElement({ display: 'none'}, subtitleDoc);
  }
